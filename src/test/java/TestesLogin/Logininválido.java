...
public class Logininválido {
	...
	//	src/A01_Compras/Fornecedor/testFornecedor/Teste.java	
          ...
          //  we.findElement(By.name("senha")).sendKeys("246810");
            ...
            String variavel1 = "Não foi possível logar  no sistema , pois  o login está inválido!"; //criando aqui as variaveis precisao ser inicializadas
